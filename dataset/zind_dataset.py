...
class ZindDataset(BaseDataset):
    def __init__(self, root_dir, mode, type='normal', shape=None, max_wall_num=0, aug=None, camera_height=1.6, logger=None,
        ...
        pano_list = read_zind(layout_type='layout_raw',
                              partition_path=os.path.join(data_dir, f"zind_partition.json"),
